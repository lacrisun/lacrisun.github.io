...
import { ExternalLink, Github, Brain, Smartphone, BarChart3 } from 'lucide-react'
  ...
  const projects = [
    {
      ...
      icon: BarChart3,
      technologies: ['Vite', 'React', 'JavaScript', 'Algorithms'],
      liveUrl: 'https://algosorting.netlify.app/',
      githubUrl: 'https://github.com/lacrisun/algosorting',
    },
    {
      title: 'Lacri AI',
      description: 'A Discord bot powered by Groq AI that embodies the personality of Dexter Morgan while providing helpful assistance to users.',
      icon: Brain,
    ...
    {
      title: 'Alharom App',
      description: 'A fullstack app of an Islamic Hajj Travel company complete with CRUD actions for handling pilgrims.',
      icon: Smartphone,
      technologies: ['CRUD', 'Next.js', 'Cross-platform', 'React'],
      liveUrl: '#',
